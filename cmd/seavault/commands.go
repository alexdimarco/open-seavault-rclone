...
func init() {
	commands = []command{
		...
		{name: "setup", synopsis: setupSynopsis(), usage: "seavault setup [--expert] [--no-keychain] [--profile NAME] [--no-open] | seavault setup --preset synced-folder|rclone|local --vault PATH [--remote NAME] [--allow-download] [--json]", handler: cmdSetup},
		...
		{name: "verify", synopsis: verifySynopsis(), usage: "seavault verify [flags] VAULT_DIR_OR_PROFILE", handler: cmdVerify},
		...
		{name: "compact", synopsis: compactSynopsis(), usage: "seavault compact [--no-keychain] VAULT_DIR_OR_PROFILE", handler: cmdCompact},
		...
		{group: "recovery", name: "revoke", synopsis: "Retire one recovery entry by its ID.", usage: "seavault recovery revoke [--no-keychain] [--accept-rollback] VAULT_DIR_OR_PROFILE ENTRY_ID"},
		...
		{group: "remote", name: "add", synopsis: "Create a remote profile for a vault.", usage: "seavault remote add [--backend NAME] [--type rclone|local] [--transfers N] [--checkers N] [--bwlimit RATE] [--allow-destructive-sync] NAME VAULT_DIR_OR_PROFILE RCLONE_REMOTE_PATH"},
		{group: "remote", name: "edit", synopsis: "Update an existing remote profile.", usage: "seavault remote edit [--backend NAME] [--type rclone|local] [--transfers N] [--checkers N] [--bwlimit RATE] [--allow-destructive-sync] NAME VAULT_DIR_OR_PROFILE RCLONE_REMOTE_PATH"},
